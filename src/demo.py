...
from SqueezeSeg.src.config.kitti_squeezeSeg_config import kitti_squeezeSeg_config
from SqueezeSeg.src.utils.util import *
from SqueezeSeg.src.nets.squeezeSeg import SqueezeSeg
...
def detect():
  ...
  with tf.Graph().as_default():
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
      ...
      for f in glob.glob(FLAGS.input_path):
